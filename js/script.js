document.addEventListener("DOMContentLoaded", () => {
    ...
    // Adiciona eventos de clique nos dots da timeline
    const dots = timelineNav.querySelectorAll(".timeline-dot");
    const slides = timelineSlides.querySelectorAll(".timeline-slide");


    // Nova parte para a aba história: agora as setas e os círculos funcionam. Salomão rei do PVP
    let currentIndex = 0;
